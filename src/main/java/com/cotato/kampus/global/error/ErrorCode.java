...
public enum ErrorCode {
	...
	PRODUCT_PRICE_INVALID(HttpStatus.BAD_REQUEST, "상품 가격은 0 이상이어야 합니다.", "PRODUCT-204"),
	PRODUCT_DESCRIPTION_REQUIRED(HttpStatus.BAD_REQUEST, "상품 설명은 필수 항목입니다.", "PRODUCT-205"),
	PRODUCT_STATUS_REQUIRED(HttpStatus.INTERNAL_SERVER_ERROR, "상품 상태는 필수 항목입니다.", "PRODUCT-206"),
	PRODUCT_CATEGORY_REQUIRED(HttpStatus.BAD_REQUEST, "상품 카테고리는 필수입니다.", "PRODUCT-207"),
